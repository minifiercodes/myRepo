...
export class CartService {
    ...
    private currentUser: JwtResponse | undefined;

    constructor(private http: HttpClient,
        @Inject(CookieService) private cookieService: CookieService,
                private userService: UserService) {
        this.itemsSubject = new BehaviorSubject<Item[]>(null as any);
        this.items = this.itemsSubject.asObservable();
        this.totalSubject = new BehaviorSubject<number>(null as any);
    ...
    update(productInOrder: ProductInOrder): Observable<ProductInOrder>  {
        ...
        if (this.currentUser) {
            ...
            return null as unknown as Observable<ProductInOrder> ;
        }
        //} catch (err) {
            //return null as unknown as Observable<ProductInOrder> ;
        //}    
